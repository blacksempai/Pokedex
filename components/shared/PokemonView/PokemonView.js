...
import { types } from './../../Pokemon/PokemonTypes.domain';
    ...
    return (
        <View>
            ...
            <View style={styles.params_container}>
                <View>
                    <Text style={styles.param_text_main}>{pokemon.weight / 10} KG</Text>
                    <Text style={styles.param_text_sub}>Weight</Text>
                </View>
                <View>
                    <Text style={styles.param_text_main}>{pokemon.height / 10} M</Text>
